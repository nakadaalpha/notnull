          ...
          <div class="wrapper-H rounded-4">
            <div class="parent-H">
              <a href="https://www.koenigsegg.com/">
                <div class="child-H">
                  <img src="public/src/images/1.png" class="img-fluid">
                </div>
        ...
        <div data-aos="fade-up" data-aos-once="true" data-aos-duration="750">
          <div class="wrapper-H rounded-4">
            <div class="parent-H">
              <a href="catalog">
                <div class="child-H">
                  <img src="public/src/images/2.png" class="img-fluid">
                </div>
                <div class="child-title-H">
                  McLaren F1
                </div>
        ...
        <div data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">
          <div class="wrapper-H rounded-4">
            <div class="parent-H">
              <a href="catalog">
                <div class="child-H">
                  <img src="public/src/images/4.png" class="img-fluid">
                </div>
                <div class="child-title-H">
        ...
        <div data-aos="fade-up" data-aos-once="true" data-aos-duration="500">
          <div class="wrapper-H rounded-4">
            <div class="parent-H">
              <a href="catalog">
                <div class="child-H">
                  <img src="public/src/images/7.png" class="img-fluid">
                </div>
                <div class="child-title-H">
                  Cadillac Escalade
                </div>
        ...
        <div data-aos="fade-up" data-aos-once="true" data-aos-duration="750">
          <div class="wrapper-H rounded-4">
            <div class="parent-H">
              <a href="catalog">
                <div class="child-H">
                  <img src="public/src/images/5.png" class="img-fluid">
                </div>
                <div class="child-title-H">
                  BMW M4 Coupe
                </div>
        ...
        <div data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">
          <div class="wrapper-H rounded-4">
            <div class="parent-H">
              <a href="catalog">
                <div class="child-H">
                  <img src="public/src/images/6.png" class="img-fluid">
                </div>
                <div class="child-title-H">
                  BMW M8 Coupe
                </div>
    ...
    <div class="row">
      <div class="col-6 col-md-4 col-lg-3 my-3">
        <div data-aos="fade-up" data-aos-once="true" data-aos-duration="250">
          <div class="wrapper-BS shadow rounded-4">
            <div class="parent-BS">
              <a href="catalog">
                <div class="child-BS">
                  <img src="public/src/images/brand/1.png" width="400px">
                </div>
                <div class="child-title-BS">
                  Koenigsegg
                </div>
              </a>
            </div>
      ...
      <div class="col-6 col-md-4 col-lg-3 my-3">
        <div data-aos="fade-up" data-aos-once="true" data-aos-duration="500">
          <div class="wrapper-BS shadow rounded-">
            <div class="parent-BS">
              <a href="catalog">
                <div class="child-BS">
